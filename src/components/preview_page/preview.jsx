    ...
    <>
      ...
      <Container
        ...
        <div className="resume-preview-grid-container">
          ...
          {(Template === TEMPLATE_1) && <div><Template1 input={input} /></div>}
          {(Template === TEMPLATE_2) && <div><Template2 input={input} /></div>}
          {(Template === TEMPLATE_3) && <div><Template3 input={input} /></div>}
          {(Template === TEMPLATE_4) && <div><Template4 input={input} /></div>}

    ...
    <>
      ...
      <Stack p={{ xs: "15px", sm: "25px", md: "40px", lg: "60px " }}>
        ...
        <Box mt="25px">
          ...
          <Box className="icons">
            <Link to="https://www.instagram.com/its__riaa22/profilecard/?igsh=MW5kN2FjNDUwZWVsOQ==">
              <Instagram
            ...
            <Link to="https://www.linkedin.com/in/ria-sadhu-b0837b268/">
              <LinkedInIcon
                sx={{ fontSize: "40px", paddingLeft: "15px" }}
                color="primary"
              />
            ...
            <Link to="https://github.com/Ria555s">
              <GitHub
